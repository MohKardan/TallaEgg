...
[English](README.md) | [العربية](README.ar.md) | **Türkçe** | [Français](README.fr.md) | [中文](README.zh-CN.md) | [Deutsch](README.de.md) | [हिन्दी](README.hi.md)
...
> ⚠️ **Eski bot jetonları ve eski ortak API anahtarı bu depoda hâlâ okunabilir durumdadır** — git geçmişinde, çünkü bu dosya eskiden izleniyordu, ve izlenen bir kaynak dosyada: kendine ait bir yapılandırma anahtarı olmayan, `TallaEgg.TelegramBot.Infrastructure/Program.cs` içindeki `TelegramLoggerService` kaydında. **Bunların her biri [#33](https://github.com/MohKardan/TallaEgg/issues/33) kapsamında yenilenmiştir ve geçersizdir — bunları aktif bir sızıntı olarak bildirmeyin.** Yeni okuyucular her incelemede bunları yeniden keşfedip bir olay kaydı açıyor; her seferinde yanlış alarmdır. Geçmiş bilinçli olarak yeniden **yazılmamıştır** — bu karar ve gerekçesi [#105](https://github.com/MohKardan/TallaEgg/issues/105) içindedir. Yapılandırma dosyası artık git tarafından yok sayılmaktadır; onu veya yeni herhangi bir gizli bilgiyi sürüm kontrolüne yeniden eklemeyin.
