...
Reproduced **verbatim** from the chat where it was written, including the three
`[7/8/2026 10:43 PM] Ali:` lines, which are message boundaries rather than content — one of
them falls in the middle of a list. Nothing was corrected, reordered, or tidied: an archived
method is evidence, and evidence is not edited to read better.

Everything below this line is the original.

---

[7/8/2026 10:43 PM] Ali: # Role
...
allocations
[7/8/2026 10:43 PM] Ali: LINQ inefficiencies
...
[7/8/2026 10:43 PM] Ali: Language Requirement
