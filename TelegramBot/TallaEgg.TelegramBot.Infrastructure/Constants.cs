...
namespace TallaEgg.TelegramBot.Infrastructure
{
    ...
    public static class BotMsgs
    {
        ...
        public const string MsgAdminHelp = "🔧 دستورهای مدیریت\n\n" +
                                          ...
                                          "معامله‌های کاربر: معامله [شمارهٔ تلفن]\n\n" +
                                          "تغییر سطح دسترسی:\n" +
                                          "ن [شمارهٔ تلفن] [نقش]\n" +
                                          ...
                                          "فعال/غیرفعال‌کردن نماد:\n" +
                                          "نماد فعال [نماد] یا نماد غیرفعال [نماد]\n" +
                                          "نمونه: نماد فعال سکه\n" +
                                          "(بدون ذکر نماد، آبشده)\n\n" +
    ...
    public static class ReleaseNotes
    {
        private static readonly Dictionary<string, string[]> Notes = new()
        {
            ["1.6.0"] = new[]
            {
                "منوی ربات بعد از تأیید حساب نمایش داده می‌شود، نه پیش از آن",
                "ثبت درست شماره تلفن هنگام اشتراک‌گذاری مخاطب",
                "پیام روشن‌تر هنگام کافی نبودن موجودی",
            },
            ["1.5.0"] = new[]
            {
                "اعمال حداقل و حداکثر مقدار در همه‌ی سفارش‌ها، با پیام روشن هنگام رد سفارش",
                "حداکثر هر سفارش: سکه ۵ عدد و بیت‌کوین ۱ واحد",
            },
            ["1.4.0"] = new[]
            {
