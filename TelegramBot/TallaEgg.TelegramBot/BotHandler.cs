...
namespace TallaEgg.TelegramBot
{
    ...
    public class BotHandler: IBotHandler
    {
        ...
        private async Task HandleMainMenuAsync(long chatId, long telegramId, Message message)
        {
            ...
            switch (msgText)
            {
                ...
                case BotTexts.BtnCash:
                    await HandleCashMenuAsync(chatId);
                    break;
        ...
        private async Task HandleCashMenuAsync(long chatId)
        {

            await _botClient.SendCashMenuKeyboard(chatId);
        }
        ...
        public Task HandleCallbackQueryAsync(object callbackQuery)
        {
            throw new NotImplementedException();
        }
    }
